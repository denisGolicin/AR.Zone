...
const notificationBlock = document.querySelector('.wrapper-notification');
const notificationText = document.querySelector('#notification-text');
const notificationClose = document.querySelector('#notification-close');

register.addEventListener('click', function(){
    notificationPush(notification.open, "Функция в разработке!");
});
passwordChange.addEventListener('click', function(){
    notificationPush(notification.open, "Функция в разработке!");
});
notificationClose.addEventListener('click', function(){
    notificationPush(notification.close)
});

enter.addEventListener('click', function(){
    if(login.value != "admin"){
        notificationPush(notification.open, "Не верный логин!");
        return;
    }
    if(password.value != "admin"){
        notificationPush(notification.open, "Не верный пароль!");
        return;
    }
...
function notificationPush(type, text = "Уведомление"){
    switch(type){
